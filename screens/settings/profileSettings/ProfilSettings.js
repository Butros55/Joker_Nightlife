...
const ProfileSettings = ({navigation}) => {
  ...
  return (
    ...
    <View style={{ alignItems: 'center', top: '19%'}}>
      ...
      <Text style={[styles.profilename, {fontWeight: 500, color: theme.text}]}>{userData.vorname} {userData.zweitername !== '' || undefined && <Text>{userData.zweitername} </Text>}{userData.nachname}</Text>
